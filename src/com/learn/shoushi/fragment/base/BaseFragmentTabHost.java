...
/**
 * Created by a0153-00401 on 15/11/11.
 */
public class BaseFragmentTabHost extends TabHost
        implements TabHost.OnTabChangeListener {

    private final static String tag =  "baseFragmentTabHost";
    ...
    public BaseFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
