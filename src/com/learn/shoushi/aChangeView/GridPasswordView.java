 ...
 */
public class GridPasswordView extends LinearLayout implements GridPasswordInterface{
    ...
    private static final int DEFAULT_GRID_COLOR = 0xffffffff;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textColor == null)
            textColor = ColorStateList.valueOf(getResources().getColor(R.color.login_orange));
        int textSize = ta.getDimensionPixelSize(R.styleable.gridPasswordView_textSize, -1);
        if (textSize != -1) {
            this.textSize = Methods.px2sp(context, textSize);
        }

        lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineWidth, Methods.dp2px(getContext(), 1));
        lineColor = ta.getColor(R.styleable.gridPasswordView_lineColor, DEFAULT_LINE_COLOR);
        gridColor = ta.getColor(R.styleable.gridPasswordView_gridColor, DEFAULT_GRID_COLOR);
        ...
        passwordLength = ta.getInt(R.styleable.gridPasswordView_passwordLength, DEFAULT_PASSWORD_LENGTH);
    ...
    private void inflaterViews(Context context) {
        ...
        while (index < passwordLength) {
            View dividerView = inflater.inflate(R.layout.grid_password_divided_line, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.grid_password_textview, null);
    ...
    @Override
    public void setPasswordType(GridPasswordType passwordType) {
