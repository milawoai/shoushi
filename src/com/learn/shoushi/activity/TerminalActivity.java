...
public class TerminalActivity extends BaseFragmentActivity {
    ...
    /*public static WrapIntent newTransWrapIntent(final Context context, final Class<? extends Fragment> cls, final Bundle args) {
        return new WrapIntent(context, cls, args, TransTerminalActivity.class);
    }*/
   ...
   /* public static void showTransFragment(final Context context,
                                         final Class<? extends Fragment> cls, final Bundle args) {
        newTransWrapIntent(context, cls, args).show();
    }*/
...
//        mIsHideKeybord = false;
    ...
    private boolean mIsRewriteOnback = false;  //是否重写OnbackProress()
